      ...
      >
        <Card className="border-none bg-white/90 dark:bg-black/80 backdrop-blur-md shadow-2xl">
          <CardHeader className="flex flex-col items-center pt-8 pb-4">
            ...
            <p className="text-default-500 mt-1">Ready to continue your journey?</p>
          </CardHeader>
          ...
          <CardBody className="px-8 py-4">
            ...
            <div className="relative flex items-center py-6">
              ...
              <span className="flex-shrink mx-4 text-xs font-medium text-default-400 uppercase tracking-wider">or continue with</span>
              <div className="flex-grow border-t border-default-200"></div>
            </div>
