          ...
          {question.options.map((option, i) => (
            ...
            >
              <button 
                ...
                disabled={disabled}
                className={`w-full h-16 sm:h-20 px-8 text-lg sm:text-xl font-bold rounded-2xl border-2 transition-all duration-300 text-left flex items-center justify-between ${
