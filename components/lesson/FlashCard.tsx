        ...
        <CardBody className="flex flex-col items-center justify-center p-10 sm:p-16 min-h-[350px]">
          ...
          <div className="flex flex-col items-center gap-4">
            <button
              onClick={() => handlePlay()}
              disabled={disabled}
              className={`relative w-24 h-24 sm:w-28 sm:h-28 rounded-full flex items-center justify-center transition-all duration-500 ${isPlaying ? 'bg-sky-500 shadow-[0_0_40px_rgba(56,189,248,0.5)]' : 'bg-slate-100 dark:bg-slate-800 hover:bg-sky-500/10 border-2 border-transparent hover:border-sky-500/30'
                }`}
            >
